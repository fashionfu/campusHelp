        ...
        <div style="padding: 30px;" class="layui-fluid">
            ...
            <div class="layui-row">
                ...
                <div class="layui-col-md2">
                    <a onclick="addSchool()" class="layui-btn layui-btn-sm layui-btn-primary layui-btn-radius">添加商品</a>
                </div>
            </div>
                    ...
                    <fieldset class="layui-elem-field">
                        ...
                        <c:forEach items="${list }" var="product">
                            ...
                            <div style="margin-left: 30px;margin-right: 30px;margin-top: 10px;margin-bottom: 30px;">
                                <a onclick="getSchool(${product.id })"
                                   class="layui-btn layui-btn-sm layui-btn-primary layui-btn-radius">详细设置</a>

                                <a href="${pageContext.request.contextPath}/admin/deleteProduct.do?id=${product.id}" class="layui-btn layui-btn-sm layui-btn-danger layui-btn-radius">删除</a>
                            </div>
...
<script>
    function getSchool(id) {
        ...
        layer.open({
            ...
            shade: false,
            area: ['1000px', '490px'],
            content: 'admin/getOneProduct.do?id=' + id
        });
    }
