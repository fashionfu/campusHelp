...
<div class="layui-layout layui-layout-admin">
    <div class="layui-header">
        ...
        <ul class="layui-nav layui-layout-left">
            ...
            <li class="layui-nav-item"><a href="admin/productList.do">外卖管理</a></li>
    ...
    <div class="layui-side layui-bg-black">
        <div class="layui-side-scroll">
            ...
            <ul class="layui-nav layui-nav-tree" lay-filter="test">
                ...
                <li class="layui-nav-item layui-nav-itemed"><a href="javascript:;">外卖管理</a>
                    <dl class="layui-nav-child">
                        <dd>
                            <a href="admin/productList.do">商品管理</a>
                        </dd>
                    </dl>
                </li>
                    ...
                    <fieldset class="layui-elem-field">
                        ...
                        <c:forEach items="${list }" var="task">
                            ...
                            <div style="margin-left: 20px;margin-right: 30px;">
                                ...
                                <span class="layui-badge layui-bg-gray">发布时间：<fmt:formatDate value="${task.addtime }"
                                                                                             pattern=" yyyy-MM-dd HH:mm:ss"/></span>
                                <c:if test="${task.state!=0 }">
                                    <span class="layui-badge layui-bg-gray">结束时间：<fmt:formatDate
                                            value="${task.endtime }" pattern=" yyyy-MM-dd HH:mm:ss"/></span>
                                </c:if>
                            ...
                            <div style="margin-left: 30px;margin-right: 30px;margin-top: 10px;margin-bottom: 30px;">
                                <a onclick="getAuser(${task.publishUserId })"
                                   class="layui-btn layui-btn-sm layui-btn-primary layui-btn-radius">查看发布者信息</a>
                                <c:if test="${task.state==0 }">
                                    <a href="admin/taskclose.do?words=${words }&schoolidstr=${schoolidstr }&tidstr=${task.taskid }"
                                       class="layui-btn layui-btn-sm layui-btn-primary layui-btn-radius">取消该任务</a>
                                </c:if>
                                <c:if test="${task.state==1 }">
                                    <button class="layui-btn layui-btn-sm layui-btn-disabled layui-btn-radius">任务已关闭
                                    </button>
                                </c:if>
                                <c:if test="${task.state==2 }">
                                    <a onclick="getAuser(${task.acceptUserId })"
